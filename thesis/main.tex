...
de FinMultiTime, validación walk-forward, ablaciones y análisis de incertidumbre.
Este documento es una base de redacción. La implementación y los resultados
experimentales todavía no se han realizado.
\end{abstract}
\tableofcontents
...
dejan de hacerlo. La modalidad es una comparativa de soluciones.
...
La comparación incluirá referencias ingenuas, regresión regularizada, boosting y
una red temporal compacta. El modelo propuesto se contrastará con variantes sin
...
reiniciará por fold y las actualizaciones respetarán la maduración de etiquetas.

Se medirán error, dirección, ranking, calibración y recursos. La simulación usará
retornos de activos y un registro de operaciones con costes de apertura y cierre.
El protocolo fijará las comparaciones principales antes de abrir el test final.

\chapter{Resultados y discusión}
No hay resultados experimentales en esta versión. Este capítulo se redactará
desde predicciones, métricas y artefactos identificados por configuración y commit.
