...
**Estado actual:** preparación multimodal implementada, referencias tabulares evaluadas y 96 ejecuciones de GRU, DLinear, RNN y LSTM registradas, incluidas variaciones de pérdida, tasa de aprendizaje, semilla y continuación controlada. Estas ejecuciones utilizan 65 muestras con las cuatro modalidades admitidas, 50 de entrenamiento y 15 de validación. Dos ejecuciones relacionadas de RNN obtienen un MAE menor que el de la predicción cero, pero ninguna media entre tres semillas mejora ese control. Los informes de [GRU y DLinear](reports/baselines/reference-variants.md) y [RNN y LSTM](reports/baselines/recurrent-comparison.md) conservan las medidas y sus límites.
