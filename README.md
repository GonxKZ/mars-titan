...
**Última edición analizada:** terminadas 96 ejecuciones de RNN, LSTM, GRU y DLinear y cuatro controles tabulares sobre una edición de 405 muestras, 205 de entrenamiento y 200 de validación. Ningún ajuste mejora la predicción cero en MAE o MSE de validación. El [informe de esta edición](reports/baselines/streaming-reference-study.md) conserva configuraciones, figuras, errores y límites. Los 55 activos con muestras se reparten entre 26 de ajuste y 36 de validación, con siete comunes. Esta cobertura no representa el corpus completo.

El [ejecutor recuperable](docs/engineering/reference-campaign.md) recorre todas las filas admitidas de cada edición, continúa desde el cursor confirmado y conserva los casos terminados. La campaña anterior de [295 muestras](reports/baselines/verified-reference-study.md) también completó 100 ajustes. Los ensayos sobre [105 muestras](reports/baselines/expanded-comparison.md) y [65 observaciones](reports/baselines/recurrent-comparison.md) permanecen como registros separados.
