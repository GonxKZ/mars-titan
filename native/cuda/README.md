...
Activar `MARS_TITAN_ENABLE_CUDA` solo comprueba la configuración de las herramientas. No prueba una operación del proyecto. En el equipo registrado, el conjunto de herramientas es 13.4 y el entorno de ejecución de PyTorch es 13.0. Esa diferencia debe revisarse antes de compilar extensiones, junto con el compilador anfitrión y la ABI.
