...
| D10 | La propuesta y los objetivos O1 a O6 gobiernan las ampliaciones. | La comparación multimodal residual, su memoria y la evaluación tienen prioridad sobre añadir mecanismos. | Una pregunta concreta justifique una extensión y haya datos, presupuesto y una regla de descarte. |
